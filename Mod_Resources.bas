...
On Error Resume Next
    ...
    FileRes = FreeFile
    Open App.Path & "\THEMES\About.png" For Binary Access Write As #FileRes
    Put #FileRes, , Buffer
    Close #FileRes

    Buffer = LoadResData("SPLASH", "7-Clock")
    FileRes = FreeFile
    Open App.Path & "\THEMES\Splash.png" For Binary Access Write As #FileRes
    Put #FileRes, , Buffer
    Close #FileRes
